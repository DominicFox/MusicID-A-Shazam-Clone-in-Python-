...
def WriteFingerprintToTextFile(timeData, freqData, num, writeType): # Write the audio fingerprint out to a text file
    if writeType == 'w':
        fingerprintText = open('/Users/account1/Documents/Visual Studio/Python/MusicID/SampleFingerprint.txt', 'w+')
    elif writeType == 'a':
        fingerprintText = open('/Users/account1/Documents/Visual Studio/Python/MusicID/SampleFingerprint.txt', 'a+')
